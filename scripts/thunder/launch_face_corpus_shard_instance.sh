...
export STRICT_TARGET_WORKERS=$(printf '%q' "$STRICT_TARGET_WORKERS")
export TOKEN_BUILD_WORKERS=$(printf '%q' "$TOKEN_BUILD_WORKERS")
export FORCE_MIN_POSTPROCESS_WORKERS=$(printf '%q' "$FORCE_MIN_POSTPROCESS_WORKERS")
